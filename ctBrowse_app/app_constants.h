...
namespace ctb::constants
{
   ...
   inline constexpr const char* CMD_COLLECTION_BOTTLE_INVENTORY_LBL = "&Bottle Inventory\tCtrl+B";
   inline constexpr const char* CMD_COLLECTION_BOTTLE_INVENTORY_TIP = "View Individual Bottle Inventory";
   ...
   inline constexpr const char* CMD_COLLECTION_MY_CELLAR_LBL        = "&My Wine Collection\tCtrl+M";
   inline constexpr const char* CMD_COLLECTION_MY_CELLAR_TIP        = "View Personal Wine Collection";
   inline constexpr const char* CMD_COLLECTION_PENDING_WINE_LBL     = "&Pending Deliveries\tCtrl+P";
   ...
   inline constexpr const char* LBL_BIN                           = "Bin:";
   inline constexpr const char* LBL_BOTTLE_INFO                   = "Bottle Info";
   inline constexpr const char* LBL_BOTTLE_NOTE                   = "Bottle Note:";
   ...
   inline constexpr const char* LBL_CONSUME_NOTE                  = "Consumption Note:";

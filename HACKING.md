...
hidden if the `ct_search_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `ct_search_DEVELOPER_MODE` to the configure
...
Runs the executable target `ct_search_exe`.

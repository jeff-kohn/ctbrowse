...
namespace ctb
{
   ...
   public:
      ...
      { 
         ...
         CtListColumn{ Prop::QtyTotalDisplay,   CtListColumn::Format::Number,   constants::DISPLAY_COL_QTY         },
         ...
         CtListColumn{ Prop::EndConsume,        CtListColumn::Format::Number,   constants::DISPLAY_COL_DRINK_BY, 1 },
      };
      ...
      { 
         ...
         TableSort{ { Prop::QtyTotalNum, Prop::WineName                     }, constants::SORT_OPTION_QTY_TOTAL, true },
      };

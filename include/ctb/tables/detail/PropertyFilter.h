...
namespace ctb::detail
{
   ...
   struct PropertyFilter
   {
      ...
      {
         return filter_name == other.filter_name
            and prop_ids == other.prop_ids
            and compare_pred(compare_val, other.compare_val) == other.compare_pred(compare_val, other.compare_val);
      }

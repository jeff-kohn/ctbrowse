...
namespace ctb
{
   ...
   public:
      ...
      static inline constexpr frozen::map<PropId, FieldSchema, static_cast<size_t>(PropId::WineAndVintage)> CsvSchema
      {
         ...
         { PropId::PurchaseDate,    FieldSchema { static_cast<uint32_t>(PropId::PurchaseDate),   PropType::Date,        3 }}, 
         { PropId::QtyPending,      FieldSchema { static_cast<uint32_t>(PropId::QtyPending),     PropType::UInt16,      3 }},
         { PropId::QtyOrdered,      FieldSchema { static_cast<uint32_t>(PropId::QtyOrdered),     PropType::UInt16,      3 }},
